...
class NullableGlobal extends Serializer<NullableGlobal> with _$NullableGlobal {
    ...
    NullableGlobal({this.foo: "bar", this.bar: "foo", this.list : const [ "foo", "bar"]});
...
class NullableGlobal1 extends Serializer<NullableGlobal1> with _$NullableGlobal1 {
    String foo;
    String bar;
...
@GenSerializer()
class NonNullableGlobal extends Serializer<NonNullableGlobal> with _$NonNullableGlobal {
    String foo;
    String bar;
...
class NonNullableGlobal1 extends Serializer<NonNullableGlobal1> with _$NonNullableGlobal1 {
    String foo;
    String bar;
...
class NonNullableComplex extends Serializer<NonNullableComplex> with _$NonNullableComplex {
    String foo;
    String bar;
...
class NullableComplex extends Serializer<NullableComplex> with _$NullableComplex {
    String foo;
    String bar;
