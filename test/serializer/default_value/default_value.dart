...
@GenSerializer(
    fields: const {
        'foo': const DefaultStringValue("bar")
    }
)
...
@GenSerializer(
    fields: const {
        'foo': const DefaultDoubleValue(42.42)
    }
)
...
@GenSerializer(
    fields: const {
        'foo': const DefaultBoolValue(true)
    }
)
...
@GenSerializer(
    fields: const {
        'foo': const [ const DefaultStringValue("1994-03-29T06:00:00Z"), const DateTimeProcessor(), const EnDecode("f")]
    }
)
